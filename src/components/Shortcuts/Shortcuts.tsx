...
export default function Shortcuts() {
  ...
  const shortcuts: TshortcutList[] = [
    ...
    },
    {
      id: 3,
      title: 'Images',
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-image" viewBox="0 0 16 16">
    ...
    },
    {
      id: 4,
      title: 'Messages',
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chat-text" viewBox="0 0 16 16">
